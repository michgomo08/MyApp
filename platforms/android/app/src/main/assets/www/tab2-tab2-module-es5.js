  ...
  function srcAppTab2Tab2PageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var Tab2Page = /*#__PURE__*/function () {
      ...
      _createClass(Tab2Page, [{
        ...
        key: "validarPIN",
        value: function validarPIN(pin, ev) {
          ...
          cordova.plugins.MyPlugin.testMichael('Validando certificado', function (response) {
            alert(response); // tslint:disable-next-line: only-arrow-functions
          }, function (error) {
            alert(error);
          });
        }
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], Tab2Page);
    /***/
  }
}]);
